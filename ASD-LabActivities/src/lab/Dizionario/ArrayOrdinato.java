...
public class ArrayOrdinato implements Dizionario {
	...
	public static void main(String args[]) throws InterruptedException {
		...
		/*
		 * Dizionario d = new Dizionario(); d.insert("3492615513", "Fedele");
		 * d.insert("3926859540", "Kim"); d.insert("3388401402", "Babbo");
		 * d.insert("3926859541", "Kim"); d.insert("3280281100", "Mamma");
		 * 
		 * Object result = d.search("Babbo");
		 * 
		 * System.out.println("* * * Ricerca * * *"); if (result != null)
		 ...
		 * d.delete("Babbo");
		 * 
		 * System.out.println("* * * Ricerca dopo cancellazione * * *"); result
		 * = d.search("Babbo");
		 * 
		 * if (result != null) System.out.println(result.toString()); else
		 * System.out.println("Nessun risultato!");
		 */
